...
async function handleAuth(request, env) {
  ...
  const token = await signToken(user.username, user.role, country, facility, isOwner, false, Array.isArray(user.allowedViews) ? user.allowedViews : null, Array.isArray(user.multiScopes) ? user.multiScopes : null);
  return json({ token, username: user.username, role: user.role, country, facility, isOwner, global: false, allowedViews: Array.isArray(user.allowedViews) ? user.allowedViews : null, multiScopes: Array.isArray(user.multiScopes) ? user.multiScopes : null });
}
