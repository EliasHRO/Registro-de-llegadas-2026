...
async function handleAuth(request, env) {
  ...
  // ---- Superusuarios globales: mismo usuario/contraseña en cualquier país/bodega,
  // con acceso y permisos de eliminar sobre TODOS los países y bodegas. Cada uno tiene su propia contraseña. ----
